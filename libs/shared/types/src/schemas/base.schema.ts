...
export const coordinatesArraySchema =
...
export const ErrorResponseSchema = z.object({
  ...
  details: z.record(z.unknown()).optional().describe('Optional detailed information about the error, such as validation errors.'),
